...
for i = 1:200
    x_true = imread(strcat('C:\Users\lyn\Desktop\picture\Ground truth\target-200h\',sprintf('%d.png',i)));
    x = imread(strcat('C:\Users\lyn\Desktop\S1BL2000\',sprintf('%d.png',i)));
    p = compute_psnr(x, x_true);
    s = compute_ssim(x, x_true);
    tp = tp + p;
    ts = ts + s;
end
